package com.teoryul.newsly.ui.fragment.favoritesourcefeed;
...
import com.teoryul.newsly.presenter.favoritesourcefeed.FavoriteSourceFeedContract;
import com.teoryul.newsly.ui.fragment.BaseNewsFeedFragment;

public class FavoriteSourceFeedFragment extends BaseNewsFeedFragment
        implements FavoriteSourceFeedContract.View {

    private Menu optionsMenu;

    public static FavoriteSourceFeedFragment newInstance() {
        return new FavoriteSourceFeedFragment();
    }
    ...
    private boolean processFavoriteMenuItemClick() {
        try {
            ((FavoriteSourceFeedContract.Presenter) presenter).addNewsFeedToFavorites();
